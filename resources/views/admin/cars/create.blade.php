...
<div class="d-flex align-items-center justify-content-between mb-4">
    <div>
        ...
        <p class="text-muted mb-0">Add car in Most searched or Latest section.</p>
    </div>
            ...
            <div class="row g-3">
                ...
                <div class="col-md-6">
                    ...
                    <select name="type" class="form-select @error('type') is-invalid @enderror">
                        ...
                        <option value="most_searched" {{ old('type')=='most_searched' ? 'selected' : '' }}>Most Searched</option>
                        <option value="latest" {{ old('type')=='latest' ? 'selected' : '' }}>Latest</option>
                    </select>
                    @error('type') <div class="text-danger small mt-1">{{ $message }}</div> @enderror
                </div>

                <div class="col-md-6">
                    <label class="form-label fw-semibold">Car Image <span class="text-danger">*</span></label>
                    <input type="file"
                           name="image"
                           class="form-control @error('image') is-invalid @enderror"
                           accept="image/*"
                           onchange="previewImage(event)">
                    <div class="small text-muted mt-1">Recommended size: 600x400</div>
                ...
                <div class="col-12">
                    <div class="border rounded-4 p-3 bg-light">
                        ...
                        <img id="preview"
                             src="https://via.placeholder.com/600x400?text=Car+Image+Preview"
